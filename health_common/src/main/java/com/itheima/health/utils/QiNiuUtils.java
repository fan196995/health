...
public class QiNiuUtils {
    ...
    private static final String BUCKET = "health006";
    public static final String DOMAIN= "http://qe68fbkc7.bkt.clouddn.com/";


  /*  public static void main(String[] args) {
        uploadFile("F:\\develop\\feiq\\Recv Files\\深圳javaeeweb\\06传智健康\\第3天\\资料\\图片资源\\03a36073-a140-4942-9b9b-712cecb144901.jpg","dlrb.jpg");
